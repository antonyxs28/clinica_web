            ...
            <div className="w-full max-w-[560px] bg-card rounded-sm shadow-sm border border-border p-10 lg:p-14">
                <div className="flex items-center justify-between mb-12">
                    <div className="flex items-center gap-3">
                        <div className="size-6 bg-primary rounded-sm shrink-0" aria-hidden />
                ...
                <p className="text-sm text-muted-foreground max-w-[44ch] mb-12">
                    Registre um novo membro da equipe. O nível de acesso determina a visibilidade no sistema.
                </p>

                <form className="flex flex-col gap-6">
                    <div className="flex flex-col gap-2">
                        <label htmlFor="nome" className="text-xs font-semibold uppercase tracking-widest">
                            Nome completo
                        </label>
                        <Input
                            id="nome"
                    ...
                    <div className="flex flex-col gap-2">
                        <label htmlFor="senha" className="text-xs font-semibold uppercase tracking-widest">
                            Senha
                        </label>
                        <Input
                            id="senha"
                            ...
                            {ROLES.map((r) => {
                                ...
                                return (
                                    <label key={r.value} className="relative cursor-pointer group">
                                        ...
                                        />
                                        <div
                                            className={`h-10 flex items-center justify-center rounded-sm transition-all ${checked
                                                ? "bg-card shadow-[inset_0_1px_0_hsl(0_0%_100%)]"
                                                : "bg-background"
                                                }`}
                                        >
                                            <span
                                                className={`text-xs font-semibold uppercase tracking-wider transition-colors ${checked
                                                    ? "text-primary"
